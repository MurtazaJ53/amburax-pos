...
from platform_apps.inventory.sku_views import GenerateSkusView, SuggestSkuView
...
urlpatterns = [
    ...
    path(
        "<uuid:shop_id>/inventory/suggest-sku/",
        SuggestSkuView.as_view(),
        name="inventory-suggest-sku",
    ),
